...
impl<'a, S: ReadonlyStorage> ReadonlyGonBalances<'a, S> {
    ...
    pub fn account_amount(&self, account: &CanonicalAddr) -> U256 {
...
impl<'a, S: Storage> GonBalances<'a, S> {
    ...
    pub fn gon_balance(&self, account: &CanonicalAddr) -> U256 {
        self.as_readonly().account_amount(account)
    }

    pub fn set_account_gon_balance(&mut self, account: &CanonicalAddr, amount: U256) {
